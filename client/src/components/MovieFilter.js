  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        <div>
          <label>Rating higer than: {rating}</label>
          <Slider
            min={0}
            max={10.0}
            step={0.1}
        ...
        <div>
          <label>Runtime within: {runtime} min</label>
          <Slider
            min={45}
            max={300}
            step={1}
        ...
        <div>
          <label>Released after: {releaseYear}</label>
          <Slider
            min={1903}
            max={2025}
            step={1}
      ...
      <Button style={{ marginRight: 15 }} type="primary" onClick={handleConfirmClick}>
        Search
      </Button>
    </div >
  )
